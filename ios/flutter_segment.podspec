...
Library to let Flutter apps use Segment.io
                       DESC
  s.homepage         = 'https://github.com/totzk9/flutter-segment'
  s.license          = { :type => 'MIT', :file => '../LICENSE' }
  s.author           = 'Tyrone Chris Abad'
  s.source           = { :git => "https://github.com/totzk9/flutter-segment.git", :tag => s.version.to_s }
  ...
  s.dependency 'segment-appsflyer-ios', '6.12.1'
